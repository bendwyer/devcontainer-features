...
# Flux Operator CLI (flux-operator)
...
```json
"features": {
    "ghcr.io/bendwyer/devcontainer-features/flux-operator:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/bendwyer/devcontainer-features/blob/main/src/flux-operator/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
