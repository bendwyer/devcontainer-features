...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/bendwyer/devcontainer-features/blob/main/src/grafana-mcp-server/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
