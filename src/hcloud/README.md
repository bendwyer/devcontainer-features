...
```json
"features": {
    "ghcr.io/bendwyer/devcontainer-features/hcloud:2": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/bendwyer/devcontainer-features/blob/main/src/hcloud/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
