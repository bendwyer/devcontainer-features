...
```json
"features": {
    "ghcr.io/bendwyer/devcontainer-features/specify:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/bendwyer/devcontainer-features/blob/main/src/specify/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
