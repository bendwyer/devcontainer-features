...
```json
"features": {
    "ghcr.io/bendwyer/devcontainer-features/zensical:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/bendwyer/devcontainer-features/blob/main/src/zensical/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
